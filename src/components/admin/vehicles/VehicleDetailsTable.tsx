...
const availabilityStatusColorMap: Record<string, ChipProps["color"]> = {
  available: "success",
  unavailable: "danger",
};
...
const verifyStatusColorMap: Record<string, ChipProps["color"]> = {
  verified: "success",
  rejected: "danger",
  pending: "warning",
};
  ...
  const renderCell = React.useCallback(
    (vehicle: VehicleType, columnKey: React.Key) => {
      ...
      switch (columnKey) {
        ...
        case "refrigFlag":
          return (
            <Chip size="sm" color={cellValue === "Yes" ? "success" : "default"}>
              {cellValue}
            </Chip>
          );
            ...
            <Chip
              ...
              color={
                availabilityStatusColorMap[
                  cellValue as keyof typeof availabilityStatusColorMap
                ]
              }
            >
            ...
            <Chip
              ...
              color={
                verifyStatusColorMap[
                  cellValue as keyof typeof verifyStatusColorMap
                ]
              }
            >
              {typeof cellValue === "string"
