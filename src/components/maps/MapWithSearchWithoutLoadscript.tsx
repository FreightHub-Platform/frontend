...
interface MapWithSearchWithoutLoadScriptProps {
...
const MapWithSearchWithoutLoadScript: React.FC<
  MapWithSearchWithoutLoadScriptProps
> = ({ onPlaceSelected }) => {
...
export default MapWithSearchWithoutLoadScript;
