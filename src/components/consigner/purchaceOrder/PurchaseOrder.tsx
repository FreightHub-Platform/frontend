...
const PurchaseOrder = ({ closeFunction }) => {
  ...
  const handleAddressSelected = (formattedAddress) => {
  ...
  const [location, setLocation] = useState({
    lat: Math.floor(Math.random() * 181),
    lng: Math.floor(Math.random() * 181),
  });
  ...
  return (
    <Box component="section" sx={{ zIndex: 1000 }}>
      <Box component="section" className="rounded-2xl my-3 bg-white p-3">
        <Box
          component="section"
          sx={{ p: 1, border: "2px solid #FB8C00", borderRadius: "20px" }}
        ...
        <Box
          component="section"
          className="mb-1 flex justify-between content-center flex-row gap-5"
        >
          <Box component="section" className="basis-1/2 content-center pl-10">
            ...
            >
              ...
              <Box component="section" className="flex flex-col gap-4">
                <div className="flex flex-row gap-4 items-center">
                  ...
                  <TextField
                    ...
                    helperText={
                      storeContactError
                        ? storeContact.length == 0
                          ? "Please enter contact number"
                          : storeContact.length != 10
              ...
              <Box sx={{ display: "flex", justifyContent: "center" }}>
                <FormControlLabel
                  control={<Checkbox />}
                  label="Allow Load Sharing"
                  onChange={() => setAllowSharing(true)}
                />
              </Box>
            </Box>
          </Box>
          <Box component="section" className="flex flex-col basis-1/2">
            ...
            >
              <h1 className="text-base font-semibold ms-3 mb-2">
                Drop-Off Location
              </h1>
        ...
        <Box component="section" sx={{ textAlign: "center" }}>
          <div className="gap-5">
            ...
            {/* add close button to close this */}
            <button
              type="button"
              className="bg-slate-400 py-2 px-8 rounded-lg text-white hover:bg-gray-600 text-sm duration-500 mx-6"
              onClick={() => {
