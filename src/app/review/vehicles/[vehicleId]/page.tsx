      ...
      <div className="flex justify-center w-11/12 ">
        <div className="grid grid-cols-[400px_1fr] gap-3">
          <div className="gap-2 bg-white p-3 rounded-2xl max-h-[85vh]">
            <div className="bg-white p-5 rounded-2xl max-h-[75vh] overflow-y-auto custom-scrollbar-horizontal">
              <div>
                ...
                >
                  <div className="flex w-full text-white justify-center font-bold">
                    Driver Details
                  </div>
                  {!verifiedDriver ? (
                    <form
                      onSubmit={(e) => handleEmailSent(e, "driverMissMatch")}
                    >
                      <button
                        type="submit"
                ...
                <ProfilePhoto pic="defaultPicUrl" />
              </div>
              <div className="mt-2">
                <Details driver="s" />
              </div>
            ...
            {!verifiedDriver ? (
              <div className="flex justify-center">
                <form onSubmit={(e) => handleVerify(e, "driverVerified")}>
                  <button
                    type="submit"
                    className="bg-green-500 py-2 px-5 rounded-lg hover:bg-green-600 duration-300 hover:text-white mt-2"
                  >
                    Verify Driver
                  </button>
                </form>
          ...
          <div className="gap-2 bg-white p-3 rounded-2xl max-h-[85vh]">
            <div className="bg-white p-5 rounded-2xl max-h-[75vh] overflow-y-auto custom-scrollbar-horizontal">
              <div
                className="p-1 bg-orange-300 w-full flex justify-between mb-2 rounded-lg"
                style={{ backgroundColor: "#FF9800" }}
              >
                <div className="flex w-full justify-center font-bold text-white">
                  Vehicle Details
                </div>
                {!verifiedVehicle ? (
                  <form
                    onSubmit={(e) => handleEmailSent(e, "vehicleMissMatch")}
                  >
                    <button
                      type="submit"
                      className="me-4 hover:text-white cursor-pointer"
              ...
              <div
                className="p-1 border-3 font-bold w-full flex justify-center mb-2 mt-4 rounded-lg"
            ...
            {!verifiedVehicle ? (
              <div className="flex justify-center items-center">
                <form onSubmit={(e) => handleVerify(e, "vehicleVerified")}>
                  <button className="bg-green-500 py-2 px-5 rounded-lg hover:bg-green-600 duration-300 hover:text-white mt-2">
                    Verify Vehicle
                  </button>
                </form>
              </div>
