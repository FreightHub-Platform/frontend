    ...
    <div className="home">
      ...
      <div className="relative w-full h-screen">
        ...
        <div className="relative flex flex-col items-center justify-center w-full h-full text-center text-white">
          <h1 className="text-6xl font-bold tracking-tight sm:text-8xl mt-36 mb-5">
            FreightHub
          </h1>
          <br />
          <br />
          ...
          <p className="mt-6 text-medium leading-8 sm:text-3xl">
            The Best Freight Forwarding Solution For Your Enterprise...
          </p>
          <br />
          <br />
          <br />
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-36">
        ...
        <p className="text-lg text-gray-700">
          Transforming Logistics for a Seamless Future In today’s fast-paced
          world, efficient logistics are more critical than ever. At FreightHub,
          we specialize in delivering innovative solutions that streamline your
          supply chain, reduce costs, and improve service quality. With decades
          of industry experience and a commitment to excellence, we’re your
          trusted partner in navigating the complexities of logistics.
        </p>
      </div>
          ...
          <div className="flex flex-wrap justify-center mt-10">
            <div className="w-full sm:w-1/2 md:w-1/3 p-4">
              <div className="service-card p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Fast and reliable freight services to meet your tight
                  deadlines.
                </p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 md:w-1/3 p-4">
              <div className="service-card p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Track the progress of your freight transports in real time
                </p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 md:w-1/3 p-4">
              <div className="service-card p-6 bg-white rounded-lg shadow-md">
                <h3 className="text-xl font-bold mb-2">
                  Thousands of Vehicles at your desktop
                </h3>
                <p className="text-gray-700">
                  Access to the largest catalogue of heavy vehicles to suit your
                  needs
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center mt-10">
            <div className="w-full md:w-2/3 p-4">
              <p className="text-lg text-gray-700">
                FreightHub is a leading provider of logistics solutions, with a
                focus on innovation, efficiency, and customer satisfaction. Our
                team of experienced professionals is dedicated to delivering the
                highest quality service to meet your logistics needs. From air
                and ocean freight to land transportation, we offer a
                comprehensive range of services to help you succeed in
          ...
          <div className="flex flex-wrap justify-center mt-10">
            <div className="w-full sm:w-1/2 md:w-1/3 p-4">
              <div className="testimonial-card p-6 bg-gray-100 rounded-lg shadow-md">
                <p className="text-gray-700">
                  \&quot;FreightHub has transformed our logistics operations,
                  making them more efficient and cost-effective.&quot;
                </p>
                <p className="mt-4 font-bold">
                  - John Doe, CEO of Logistics Co.
                </p>
              </div>
            </div>
            <div className="w-full sm:w-1/2 md:w-1/3 p-4">
              <div className="testimonial-card p-6 bg-gray-100 rounded-lg shadow-md">
                <p className="text-gray-700">
                  &quot;The best freight forwarding service we&apos;ve ever
